...
When electronics projects need power distribution to more than a few components, we typically need to start splicing wires. It takes extra time, materials, space, and my results typically look like a rat's nest. I wanted a simple way to distribute power to a bunch of components without having to splice wires.

# How?

A simple PCB that distributes power would be enough to clean up my piles of spliced spaghetti. I could solder wires to it like any other PCB in seconds without splicing, heat shrink tubing, and cursing.

# What?

Proto Power Rails has 3 power lines, and I typically use them to distribute ground, battery, and regulator. 
...
- A regulator rail for components with low current draw. The microcontroller can typically manage this regulator to save power and allow charging while the main features of the device are off.
